...
export class NAUTH_Connector {
    ...
    private setToken(value: string) {
        if (value)
            cookie.save('NAUTH_AUTHENTICATION_TOKEN', value, { path: '/',maxAge: 987987987,domain: dev ? "" : "https://*.nozsa.com" });
        else
    ...
    private setWaitToken(value: string) {
        ...
        if (value)
            cookie.save('NAUTH_WAIT_TOKEN', value, { path: '/', maxAge: 987987987,domain: dev ? "" : "https://*.nozsa.com" });
        else
