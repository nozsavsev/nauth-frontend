...
import emailVerification from "../public/lottie/email.json";
...
const IndexPage = observer(({ NAUTH }: { NAUTH: NAUTH_Connector }) => {
        ...
        if (NAUTH.wType === "restoringSession")
            ...
            return <div className="container">
                <div style={{
                    ...
                    <Lottie animationData={emailVerification} play={true} loop={true} />
                </div>
            </div>
    }
    else if (NAUTH.AuthStatus === false)
        return <div className="container">
            <Login
                NAUTH={NAUTH}
    ...
    else return <div className="container" style={{ flexDirection: "column" }}>

        <button className="Button" onClick={() => {


        }}>continue as {NAUTH.CurrentUser.username}</button>

        <button className="Button" onClick={() => {

            NAUTH.REST_RevokeSession(null);

        }}>Login with another accout</button>
...
export const Login = observer(({ onSuccess, onRegister, NAUTH }: { onSuccess?: any, onRegister: any, NAUTH: NAUTH_Connector }) => {
    ...
    return (
        <div style={{
            ...
            <button className='flatButton' style={{ flex: 1, width: "100%" }} onClick={onRegister}>Register</button>
